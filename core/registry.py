...
COMMAND_REGISTRY = {
    ...
    "extraction": {
        ...
        "commands": {
            ...
            "social": {
                "full_name": "extract social",
                "description": "Extract Open Graph and Twitter Card meta tags",
                "usage": "cli.py extract social [OPTIONS]",
                "example": "cli.py extract social --url https://example.com",
                "category": "extraction"
            },
            "table-csv": {
    ...
    "performance": {
        ...
        "commands": {
            "vitals": {
                "full_name": "perf vitals",
                "description": "Get Core Web Vitals (LCP, FID, CLS, TTFB)",
                "usage": "cli.py perf vitals [OPTIONS]",
                "example": "cli.py perf vitals --url https://example.com",
                "category": "performance"
            },
            "lighthouse": {
                "full_name": "perf lighthouse",
                "description": "Run basic performance audit (simplified lighthouse-style metrics)",
                "usage": "cli.py perf lighthouse [OPTIONS]",
                "example": "cli.py perf lighthouse --url https://example.com",
                "category": "performance"
            },
            "memory": {
                "full_name": "perf memory",
                "description": "Get JavaScript heap usage and DOM node counts",
                "usage": "cli.py perf memory [OPTIONS]",
                "example": "cli.py perf memory --url https://example.com",
                "category": "performance"
            }
        }
    },
    ...
    "audit": {
        "description": "Accessibility, SEO, and security audit commands",
        "commands": {
            "a11y": {
    ...
    "screenshot": {
        ...
        "commands": {
            ...
            "fullpage": {
                "full_name": "screenshot fullpage",
                "description": "Take a full page screenshot (scrolling)",
                "usage": "cli.py screenshot fullpage <FILENAME> [OPTIONS]",
                "example": "cli.py screenshot fullpage page.png --url https://example.com",
                "category": "screenshot"
            },
            "visual-diff": {
    ...
    "tabs": {
        "description": "Tab and history management commands",
        "commands": {
            "open": {
                "full_name": "tabs open",
            ...
            "back": {
                ...
                "usage": "cli.py tabs back [OPTIONS]",
                "example": "cli.py tabs back",
                "category": "tabs"
            },
            "forward": {
                "full_name": "tabs forward",
                "description": "Navigate forward in history",
                "usage": "cli.py tabs forward [OPTIONS]",
                "example": "cli.py tabs forward",
                "category": "tabs"
            },
            "history": {
                "full_name": "tabs history",
                "description": "Get browser history for current page",
                "usage": "cli.py tabs history [OPTIONS]",
                "example": "cli.py tabs history",
                "category": "tabs"
            }
        }
    },
    "visual": {
        "description": "Visual testing commands",
        "commands": {
            "responsive": {
                "full_name": "visual responsive",
                "description": "Take screenshots at multiple viewport sizes (mobile, tablet, desktop)",
                "usage": "cli.py visual responsive [OPTIONS]",
                "example": "cli.py visual responsive --url https://example.com --output-dir screenshots",
                "category": "visual"
            },
            "dark-mode": {
                "full_name": "visual dark-mode",
                "description": "Toggle prefers-color-scheme (dark/light mode)",
                "usage": "cli.py visual dark-mode [OPTIONS]",
                "example": "cli.py visual dark-mode --enable true --url https://example.com",
                "category": "visual"
            },
            "reduced-motion": {
                "full_name": "visual reduced-motion",
                "description": "Toggle prefers-reduced-motion",
                "usage": "cli.py visual reduced-motion [OPTIONS]",
                "example": "cli.py visual reduced-motion --enable true",
                "category": "visual"
            },
            "print-preview": {
                "full_name": "visual print-preview",
                "description": "Trigger print media emulation",
                "usage": "cli.py visual print-preview [OPTIONS]",
                "example": "cli.py visual print-preview --url https://example.com --output page.pdf",
                "category": "visual"
            },
            "viewport": {
                "full_name": "visual viewport",
                "description": "Set custom viewport size",
                "usage": "cli.py visual viewport --width <W> --height <H> [OPTIONS]",
                "example": "cli.py visual viewport --width 1920 --height 1080",
                "category": "visual"
            },
            "contrast": {
                "full_name": "visual contrast",
                "description": "Toggle prefers-contrast (high/no-preference)",
                "usage": "cli.py visual contrast [OPTIONS]",
                "example": "cli.py visual contrast --enable true --url https://example.com",
                "category": "visual"
            }
        }
    },
    ...
    "content": {
        "description": "Content extraction and transformation commands",
        "commands": {
            "strip": {
                "full_name": "content strip",
                "description": "Strip HTML tags and get clean text",
                "usage": "cli.py content strip <SELECTOR> [OPTIONS]",
                "example": "cli.py content strip '.article' --url https://example.com",
                "category": "content"
            },
            "markdown": {
                "full_name": "content markdown",
                "description": "Convert HTML to Markdown",
                "usage": "cli.py content markdown <SELECTOR> [OPTIONS]",
                "example": "cli.py content markdown '.content' --url https://example.com",
                "category": "content"
            },
            "meta": {
                "full_name": "content meta",
                "description": "Extract meta tags and page metadata",
                "usage": "cli.py content meta [OPTIONS]",
                "example": "cli.py content meta --url https://example.com",
                "category": "content"
            },
            "schema": {
                "full_name": "content schema",
                "description": "Extract structured data (JSON-LD, microdata)",
                "usage": "cli.py content schema [OPTIONS]",
                "example": "cli.py content schema --url https://example.com",
                "category": "content"
            },
            "xpath": {
                "full_name": "content xpath",
                "description": "Extract elements using XPath",
                "usage": "cli.py content xpath <XPATH> [OPTIONS]",
                "example": "cli.py content xpath '//h1[@class=\"title\"]' --url https://example.com",
                "category": "content"
            },
            "regex": {
                "full_name": "content regex",
                "description": "Extract text using regex pattern",
                "usage": "cli.py content regex <PATTERN> [OPTIONS]",
                "example": "cli.py content regex '\\d{3}-\\d{3}-\\d{4}' --url https://example.com",
                "category": "content"
            },
            "forms": {
                "full_name": "content forms",
                "description": "List all forms on the page",
                "usage": "cli.py content forms [OPTIONS]",
                "example": "cli.py content forms --url https://example.com",
                "category": "content"
            }
        }
    },
    ...
    "forms": {
        "description": "Form automation commands",
        "commands": {
            "fill": {
                "full_name": "form fill",
                "description": "Auto-fill form from JSON/YAML",
                "usage": "cli.py form fill <SELECTOR> --data <FILE> [OPTIONS]",
                "example": "cli.py form fill 'form#signup' --data form-data.json --url https://example.com",
                "category": "forms"
            },
            "submit": {
                "full_name": "form submit",
                "description": "Submit form",
                "usage": "cli.py form submit <SELECTOR> [OPTIONS]",
                "example": "cli.py form submit 'form#login' --url https://example.com",
                "category": "forms"
            }
        }
    },
    "scroll": {
        "description": "Advanced scrolling commands",
        "commands": {
            "infinite": {
                "full_name": "scroll infinite",
                "description": "Auto-scroll infinite scroll pages",
                "usage": "cli.py scroll infinite [OPTIONS]",
                "example": "cli.py scroll infinite --extract '.item' --max-items 100 --url https://example.com",
                "category": "scroll"
            },
            "paginate": {
                "full_name": "scroll paginate",
                "description": "Auto-paginate and extract",
                "usage": "cli.py scroll paginate [OPTIONS]",
                "example": "cli.py scroll paginate --next 'a.next' --extract '.item' --max-pages 10",
                "category": "scroll"
            }
        }
    },
    ...
    "monitor": {
        "description": "Monitoring and debugging commands",
        "commands": {
            "console": {
                "full_name": "monitor console",
                "description": "Capture console logs",
                "usage": "cli.py monitor console [OPTIONS]",
                "example": "cli.py monitor console --filter 'error' --url https://example.com",
                "category": "monitor"
            },
            "performance": {
                "full_name": "monitor performance",
                "description": "Get performance metrics",
                "usage": "cli.py monitor performance [OPTIONS]",
                "example": "cli.py monitor performance --url https://example.com",
                "category": "monitor"
            },
            "highlight": {
                "full_name": "monitor highlight",
                "description": "Highlight elements (visual debugging)",
                "usage": "cli.py monitor highlight <SELECTOR> [OPTIONS]",
                "example": "cli.py monitor highlight 'a.broken' --color red",
                "category": "monitor"
            },
            "record": {
                "full_name": "monitor record",
                "description": "Record actions for replay",
                "usage": "cli.py monitor record <ACTION> [OPTIONS]",
                "example": "cli.py monitor record start --output actions.yaml",
                "category": "monitor"
            }
        }
    },
    "compare": {
        "description": "Comparison and snapshot commands",
        "commands": {
            "snapshot": {
                "full_name": "compare snapshot",
                "description": "Save page snapshot",
                "usage": "cli.py compare snapshot --output <FILE> [OPTIONS]",
                "example": "cli.py compare snapshot --output snap1.json --url https://example.com",
                "category": "compare"
            },
            "diff": {
                "full_name": "compare diff",
                "description": "Compare two snapshots",
                "usage": "cli.py compare diff --snapshot1 <FILE1> --snapshot2 <FILE2> [OPTIONS]",
                "example": "cli.py compare diff --snapshot1 snap1.json --snapshot2 snap2.json --format unified",
                "category": "compare"
            }
        }
    },
    "flow": {
        "description": "Conditional flow control commands",
        "commands": {
            "if": {
                "full_name": "flow if",
                "description": "Execute command conditionally based on element presence",
                "usage": "cli.py flow if <SELECTOR> [OPTIONS]",
                "example": "cli.py flow if '.error' --then-command 'echo Error found' --else-command 'echo Success'",
                "category": "flow"
            },
            "exists": {
                "full_name": "flow exists",
                "description": "Check if element exists (returns boolean)",
                "usage": "cli.py flow exists <SELECTOR> [OPTIONS]",
                "example": "cli.py flow exists '.button' --url https://example.com",
                "category": "flow"
            },
            "loop": {
                "full_name": "flow loop",
                "description": "Loop through elements and execute command for each",
                "usage": "cli.py flow loop <SELECTOR> --command <CMD> [OPTIONS]",
                "example": "cli.py flow loop '.item' --command 'echo Processing item $INDEX'",
                "category": "flow"
            }
        }
    },
    "serve": {
        "description": "Local server commands",
        "commands": {
            "start": {
                "full_name": "serve start",
                "description": "Start a local HTTP server for testing",
                "usage": "cli.py serve start [OPTIONS]",
                "example": "cli.py serve start --directory ./public --port 8000",
                "category": "serve"
            },
            "proxy": {
                "full_name": "serve proxy",
                "description": "Start a proxy server",
                "usage": "cli.py serve proxy --target <URL> [OPTIONS]",
                "example": "cli.py serve proxy --target https://example.com --port 8080",
                "category": "serve"
            }
        }
    },
